    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" autocomplete="off" placeholder="YYYY-MM-DD" required>
            </div>
...
$s="SELECT * from students where Regno='$n' and DOB='$p';";
$r=mysqli_query($conn,$s);
if (mysqli_num_rows($r)> 0){
  while($row = mysqli_fetch_array($r)){
	if($row['Regno']==$n && $row['DOB']==$p)
	{
