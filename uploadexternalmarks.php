...
<head>
    ...
    <title>Upload Attendance and Marks</title>
    <style>
    ...
    <script>
                ...
                if (data.students.length > 0) {
                    data.students.forEach(student => {
                        ...
                        row.innerHTML = `<td>${student.Regno}</td>
                                         ...
                                         <td><input type="number" name="external_mark_${student.Regno}" value="" class="editable" max="75" required /></td>
                                         `;
        ...
        // Set max internal marks and attendance
...
<body>
    ...
    <div class="form-container">
        <h2>Upload External Marks</h2>
        <form method="POST" action="upload_ext.php" onsubmit="setHiddenFields()">
            <div class="filters">
                <div>
            ...
            <table id="students">
                ...
                <tbody>
                    <tr>
                        <td colspan="3">No students available. Select a class and subject to view students.</td>
                    </tr>
                </tbody>
            </table>
            ...
            <button type="submit">Upload ExternalMarks</button>
        </form>
